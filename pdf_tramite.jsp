<!-- SCRIPS NUEVOS AGREGADOS -->
        ...
        <script>
            $(document).ready(function() {
                var tablaCargos = $('#tablaUsuarios').DataTable({
                    ...
                    buttons: [
                        {
                            ...
                            title: 'Lista de Usuarios', // Cambiar el título del EXCEL aquí
                            exportOptions: {
                                columns: [0, 1, 2, 3, 4]
                            }   
                        },
                        {
                            ...
                            title: 'Lista de Usuarios', // Cambiar el título del PDF aquí
                            exportOptions: {
                                columns: [0, 1, 2, 3, 4]
                            },
                            customize: function(doc) {
                                ...
                                doc.content[1].table.body.forEach(function(row) {
                                    row.forEach(function(cell, i) {
                                        ...
                                        cell.margin = [0, 2, 0, 2]; // Márgenes personalizados para las celdas
                                        cell.lineColor = '#aaa'; // Color de la línea de separación entre celdas
                                    });
                                });
                            }
                        }
                ...
                $('#exportarExcel').on('click', function() {
                    Realizar Pago.buttons('.buttons-excel').trigger();
                });

                $('#exportarPDF').on('click', function() {
                    Realizar Pago.buttons('.buttons-pdf').trigger();
                });
            });
        </script>